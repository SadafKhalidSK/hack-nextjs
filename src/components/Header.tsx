...
const Header = () => {
  return (
    <div className="flex bg-black h-[46px] items-center px-4 relative">

      {/* Contact Information (Left Side) */}
      <div className='absolute flex items-center left-4 sm:static sm:w-auto space-x-4 h-[46px] text-white text-[14px]'>
        <div className="h-[44px]"> (225) 555-0118 </div>
        <div className="flex items-center"> michelle.rivera@example.com </div>
      </div>

      {/* Summer Sale Banner (Center) */}
      <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center text-sm text-center px-2 sm:px-4 space-x-2 text-white text-[14px]">
        <div> Summer Sale For All Swim Suits And Free Express Delivery - OFF 50% </div>
        <button className="underline hover:no-underline"> Shop Now </button>
      </div>

      {/* Social Media Icons and Follow Us Text (Right Side) */}
      <div className="flex items-center ml-auto space-x-2 text-white text-sm sm:static">
        <div className="hidden sm:block w-[83px]">Follow Us</div>
        <Instagram size={20} className="cursor-pointer hover:text-gray-400" />
        <Facebook size={20} className="cursor-pointer hover:text-gray-400" />
        <Twitter size={20} className="cursor-pointer hover:text-gray-400" />
        <Youtube size={20} className="cursor-pointer hover:text-gray-400" />
      </div>
