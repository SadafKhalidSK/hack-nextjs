  ...
  return (
    <div className="flex bg-white px-4 h-[46px] items-center w-full max-w-screen-xl mx-auto relative">
      ...
      <div className="hidden md:flex items-center space-x-6">
        {/* Login Button */}
        <div className="mx-auto text-blue-400 font-bold text-[14px] cursor-pointer hover:text-blue-600">
          Login
        </div>

        {/* Become a Member Button */}
        <button className="w-[214px] h-[52px] bg-[#23A6F0] text-white font-bold">
          Become a member
        </button>
      </div>

      {/* Mobile View: Login and Become a Member Button */}
      <div className="flex md:hidden items-center space-x-4 ml-auto">
        <div className="text-blue-400 font-bold text-[14px] cursor-pointer hover:text-blue-600">
          Login
        </div>

        <button className="w-[140px] h-[40px] bg-[#23A6F0] text-white font-bold">
          Become a member
        </button>
      </div>
